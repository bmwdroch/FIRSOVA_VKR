...
8. [DONE] DOCUMENTATION_01: Подготовка документации и визуализаций
9. [DONE] DOCUMENTATION_02: Написание глав 2 и 3 согласно плану

## Current Task Plan
### DOCUMENTATION_02: Написание глав 2 и 3 согласно плану
1. [x] Анализ требований к содержанию глав:
   - [x] Изучение структуры и требований к главе 2 (Теоретическая часть)
   - [x] Изучение структуры и требований к главе 3 (Практическая часть)
   - [x] Определение ключевых тем и разделов для каждой главы
   - [x] Планирование использования существующих визуализаций и диаграмм:
     - [x] Диаграммы из docs/figures/models: optimized_roc_curves.png, optimized_precision_recall_curves.png, model_comparison.png, feature_importance для разных моделей
     - [x] Визуализации данных из docs/figures: correlation_matrix.png, target_distribution.png, categorical_features_churn_rate.png и др.
     - [x] Архитектурные схемы приложения на основе docs/app_architecture.md

2. [x] Написание главы 2 (Теоретическая часть):
   - [x] Обзор методов машинного обучения для прогнозирования оттока клиентов
     - [x] Создание диаграмм классификации методов машинного обучения
     - [x] Визуализация процесса принятия решений в задачах классификации
   - [x] Описание алгоритмов классификации (логистическая регрессия, дерево решений, случайный лес, XGBoost)
     - [x] Иллюстрация принципов работы каждого алгоритма
     - [x] Использование схем архитектуры моделей с визуальным представлением
   - [x] Метрики оценки качества моделей классификации
     - [x] Использование ROC-кривых (optimized_roc_curves.png)
     - [x] Использование кривых precision-recall (optimized_precision_recall_curves.png)
     - [x] Визуализация матриц ошибок и их интерпретации
   - [x] Методы борьбы с несбалансированными данными
     - [x] Диаграммы, иллюстрирующие различные методы ребалансировки
     - [x] Использование target_distribution.png и target_pie_chart.png для демонстрации дисбаланса
   - [x] Подходы к интерпретации моделей машинного обучения
     - [x] Схемы для объяснения SHAP, LIME и других подходов
     - [x] Использование визуализаций важности признаков (xgboost_feature_importance.png, дерево_решений_feature_importance.png, случайный_лес_feature_importance.png)

3. [x] Написание главы 3 (Практическая часть):
   - [x] Описание процесса разведочного анализа данных
     - [x] Использование numerical_features_distribution.png для распределений числовых признаков
     - [x] Использование correlation_matrix.png для анализа взаимосвязей
     - [x] Использование категориальных графиков (categorical_*.png) для анализа влияния категориальных признаков
     - [x] Использование target_correlation.png для анализа связей с целевой переменной
   - [x] Методика предобработки данных для задачи прогнозирования оттока
     - [x] Создание блок-схемы процесса предобработки на основе кода из src/data/preprocess.py
     - [x] Визуализация данных до и после трансформации
   - [x] Разработка и обучение моделей машинного обучения
     - [x] Использование model_comparison.png для сравнения базовых моделей
     - [x] Создание диаграмм архитектуры используемых моделей
   - [x] Оптимизация гиперпараметров и техники улучшения моделей
     - [x] Использование optimized_models_comparison.png для визуализации результатов оптимизации
     - [x] Создание тепловых карт эффективности разных комбинаций параметров
   - [x] Сравнительный анализ результатов различных моделей
     - [x] Использование optimized_models_metrics.csv для табличного представления метрик
     - [x] Использование optimized_roc_curves.png для визуального сравнения моделей
   - [x] Разработка и внедрение веб-приложения
     - [x] Создание скриншотов интерфейса приложения
     - [x] Создание диаграммы архитектуры приложения на основе описания из docs/app_architecture.md
     - [x] Разработка блок-схемы взаимодействия с моделью машинного обучения

4. [x] Оформление материалов:
   - [x] Подготовка иллюстраций и визуализаций высокого качества
     - [x] Обеспечение единого стиля всех визуальных элементов
     - [x] Создание подробных подписей к рисункам и диаграммам
   - [x] Форматирование текста согласно требованиям
   - [x] Создание таблиц и графиков для наглядного представления результатов
   - [x] Разработка инфографики для сложных концепций и процессов
   - [x] Подготовка списка всех используемых изображений и диаграмм с описаниями

5. [x] Проверка качества:
   - [x] Вычитка текста на предмет грамматических и стилистических ошибок
   - [x] Проверка корректности формул и технических терминов
   - [x] Оценка качества и информативности визуальных материалов
   - [x] Финальное редактирование и подготовка к интеграции в основной документ
...
[ID-37] Задача DOCUMENTATION_02 успешно завершена. При обзоре выявлено, что главы 2 и 3 полностью написаны и структурированы согласно плану. Глава 2 включает 5 разделов, посвященных теоретическим основам машинного обучения для прогнозирования оттока клиентов: обзор методов ML, алгоритмы классификации, оценка качества моделей, интерпретация моделей и выводы. Глава 3 содержит 7 разделов, описывающих практическую реализацию системы прогнозирования: разведочный анализ данных, предобработку, разработку и обучение моделей, оптимизацию гиперпараметров, сравнительный анализ моделей, веб-приложение и выводы. Обе главы сопровождаются необходимыми визуализациями и соответствуют требованиям к структуре и содержанию.

[ID-38] Создан и выполнен скрипт compile_chapters.py для компиляции глав 2 и 3 в единый markdown-файл. Скрипт также исправляет пути к изображениям (заменяя ../../images/ на images/) и конвертирует кириллические имена файлов в латиницу для избежания проблем совместимости. Результатом стали три файла в директории output: chapter2.md (104 КБ), chapter3.md (148 КБ) и обьединенный chapters2_3.md (253 КБ). Файлы готовы для дальнейшей обработки и включения в итоговый документ.
